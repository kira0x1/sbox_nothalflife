...
public partial class Weapon : AnimatedEntity
{
	...
	/// <summary>
	/// How much ammo you can hold
	/// </summary>
	public virtual int MagazineSize => 20;

	/// <summary>
	/// The total amount of ammo held by the player
	/// </summary>
	public virtual int MaxHeldAmmo => 120;

	/// <summary>
	/// Current amount of ammo
	/// </summary>
	[Net, Predicted] public int CurrentAmmo { get; set; }
	[Net, Predicted] public int HeldAmmoLeft { get; set; }
